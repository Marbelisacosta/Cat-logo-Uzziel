  ...
  return (
    <div className="container mx-auto py-8 md:py-12 px-2 md:px-4">
      <div className="text-center mb-12">
        <h1 className="font-headline text-3xl md:text-5xl font-bold">Mis Favoritos</h1>
        <p className="mt-2 text-sm md:text-lg text-muted-foreground">Aquí encontrarás los artículos que más te han gustado.</p>
      </div>
